...
<section class="content-section relative" id="main-content">
    ...
    <!-- Loading Spinner -->
    <div id="loading-spinner" class="absolute w-full h-[100vh] bg-white -mt-[6rem] sm:mt-10 inset-0 flex sm:items-start sm:justify-start items-center justify-center z-50">
