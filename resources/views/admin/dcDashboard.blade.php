...
<main class="app-main">
  ...
  <div class="app-content-header">
    <div class="container-fluid">
      <!-- Header & Breadcrumb -->
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Dashboard  <span style="color: #D09A3F;">(CIVIL COURT)</span></h3></div>
        <div class="col-sm-6">
  ...
  <div class="app-content">
    <div class="container-fluid">
      ...
      @php
        $cards = [
          [
            'count' => $dcOrderCopyCount,
            'text' => 'Total Applied Orders & Judgement Copies',
            'route' => 'dc-web-application',
            'bg' => 'bg-soft-applied',
          ...
          [
            'count' => $dcOrderDelivered,
            'text' => 'Total Delivered Orders & Judgement Copies',
            'route' => 'dc-web-deliver-application',
          ...
          [
            'count' => $dcWebDelivered,
            'text' => 'Total Delivered Other Copies',
            'route' => 'dc-other-delivered-copy',
            'bg' => 'bg-soft-delivered',
            'icon' => '<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
                      10-4.48 10-10S17.52 2 12 2zm-1.41 
                      14.59L6.5 12.5l1.41-1.41 2.67 
          ...
          [
            'count' => $dcOrderPending,
            'text' => 'Total Pending Orders & Judgement Copies',
            'route' => 'dc-web-pending-application',
            'bg' => 'bg-soft-pending',
