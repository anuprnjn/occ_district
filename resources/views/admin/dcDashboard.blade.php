...
<main class="app-main">
  ...
  <div class="app-content-header">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-6">
          <h3 class="mb-0">Dashboard <span style="color: #D09A3F;text-transform:uppercase;">(CIVIL COURT - {{ session('user.dist_name') }})</span></h3>
      ...
      @php
        ...
        $totalApplications = $dcOrderCopyCount + $dcWebCopyCount;
        $totalDelivered = $dcOrderDelivered + $dcWebDelivered;
        $totalPending = $dcOrderPending + $dcWebPending;
        $deliveryRate = $totalApplications > 0 ? round(($totalDelivered / $totalApplications) * 100, 1) : 0;
        $orderDeliveryRate = $dcOrderCopyCount > 0 ? round(($dcOrderDelivered / $dcOrderCopyCount) * 100, 1) : 0;
        $otherDeliveryRate = $dcWebCopyCount > 0 ? round(($dcWebDelivered / $dcWebCopyCount) * 100, 1) : 0;
      @endphp
            ...
            <div class="overall-stat-item">
              ...
              <div class="stat-content">
                ...
                <div class="stat-breakdown">
                  <span class="breakdown-item">{{ $dcOrderCopyCount }} Orders</span>
                  <span class="breakdown-divider">|</span>
                  <span class="breakdown-item">{{ $dcWebCopyCount }} Others</span>
                </div>
              </div>
            </div>
      ...
      <div class="row">
          ...
          <div class="section-card orders-section">
            ...
            <div class="section-metrics">
              <div class="metric-row">
                <div class="metric-card applied" onclick="location.href='{{ url('admin/dc-web-application') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-file-plus"></i>
                  </div>
                  <div class="metric-info">
                    <h4>{{ $dcOrderCopyCount }}</h4>
                    <p>Applied</p>
                  </div>
                </div>
                
                <div class="metric-card delivered" onclick="location.href='{{ url('admin/dc-web-deliver-application') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-check-circle"></i>
                  </div>
                  <div class="metric-info">
                    <h4>{{ $dcOrderDelivered }}</h4>
                    <p>Delivered</p>
                  </div>
                </div>
                
                <div class="metric-card pending" onclick="location.href='{{ url('admin/dc-web-pending-application') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-clock"></i>
                  </div>
                  <div class="metric-info">
                    <h4>{{ $dcOrderPending }}</h4>
                    <p>Pending</p>
                  </div>
                </div>
              </div>
            ...
            <div class="section-progress">
              ...
              <div class="progress-text">
                <span>{{ $dcOrderDelivered }} of {{ $dcOrderCopyCount }} completed</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="section-card others-section">
            ...
            <div class="section-metrics">
              <div class="metric-row">
                <div class="metric-card applied" onclick="location.href='{{ url('admin/dc-other-copy') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-file-plus"></i>
                  </div>
                  <div class="metric-info">
                    <h4>{{ $dcWebCopyCount }}</h4>
                    <p>Applied</p>
                  </div>
                </div>
                
                <div class="metric-card delivered" onclick="location.href='{{ url('admin/dc-other-delivered-copy') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-check-circle"></i>
                  </div>
                  <div class="metric-info">
                    <h4>{{ $dcWebDelivered }}</h4>
                    <p>Delivered</p>
                  </div>
                </div>
                
                <div class="metric-card pending" onclick="location.href='{{ url('admin/dc-other-pending-copy') }}'">
                  <div class="metric-icon">
                    <i class="bi bi-clock"></i>
                  </div>
                  <div class="metric-info">
            ...
            <div class="section-progress">
              ...
              <div class="progress-text">
                <span>{{ $dcWebDelivered }} of {{ $dcWebCopyCount }} completed</span>
              </div>
            </div>
          </div>
        </div>
