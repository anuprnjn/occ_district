...
@section('title', 'High Court of Jharkhand || Payment Report Civil Court')
...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0 text-secondary">Payment Report Civil Court</h3></div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Payment Report Civil Court</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-secondary card-outline mb-4">
                        <div class="card-header">
                            <div class="card-title text-secondary">Payment Report Civil Court</div>
                        </div>
                        <div class="card-body">
