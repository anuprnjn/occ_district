                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="card-title fw-semibold">Edit Payment Parameter</h5>
                            <a href="{{ route('payment_parameter_edit') }}" class="btn btn-primary">Back</a>
                        </div>

                        <form action="{{ route('role_update', ['id' => $role['role_id']]) }}" method="POST">
                            @csrf
                            <div class="mb-3">
