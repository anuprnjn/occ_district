    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Other Copy Application Details</h3>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @php
                                        ...
                                        if ($previousUrl && Str::contains($previousUrl, '/admin/dc-other-copy')) {
                                            $previousUrl = url('/admin/dc-other-copy');
                                        }
                                    @endphp
                                    ...
                                    @else
                                        <a href="{{ route('admin.dc_other_copy') }}" class="btn btn-primary">
                                            ← Back
                                        </a>
                                    @endif
                                </div>
