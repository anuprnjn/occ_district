...
<main class="app-main">
    ...
    <div class="app-content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6"><h3 class="mb-0">Civilcourt Other Copy Rejected Application</h3></div>
          <div class="col-sm-6">
                ...
                <table id="myTable" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($dcuser->rejection_date)->format('d-m-Y') }}</td>
                            <td>
                                <button class="btn btn-danger btn-sm view-details-btn" 
                                    data-bs-toggle="modal" 
                                    data-bs-target="#rejectionModal" 
                                    data-reason="{{ $dcuser->rejection_remarks }}"
                                    data-rejection-date="{{ $dcuser->rejection_date ? \Carbon\Carbon::parse($dcuser->rejection_date)->format('d-m-Y') : 'N/A' }}"
                                    data-required-documents="{{ $dcuser->required_document }}">
