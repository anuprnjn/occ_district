...
@section('title', 'High Court of Jharkhand || Web Copy Pending Application List')
...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0 text-danger">Highcourt Web Copy Pending Copies List</h3></div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">HC Pending Web Copy</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="card card-primary card-outline mb-4">
                        <div class="card-header"><div class="card-title text-danger">Highcourt Web Copy Pending List</div></div>
                        <div class="card-body">
