...
@section('title', 'High Court of Jharkhand || Pending Report')
...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0 text-danger">Pending Report</h3></div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Pending Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-danger card-outline mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="card-title text-danger">Pending Report</div>
                        </div>

                        <div class="card-body">
                            <!-- Date Filter -->
                            <form method="GET" action="{{ route('admin.pending.report') }}" class="row g-3 mb-4">
                                <div class="col-md-3">
