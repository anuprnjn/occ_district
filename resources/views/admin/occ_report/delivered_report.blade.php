...
@section('title', 'High Court of Jharkhand || Delivered Report')
...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0 text-success">Delivered Report</h3></div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Delivered Report</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-success card-outline mb-4">
                        <div class="card-header">
                            <div class="card-title text-success">Delivered Report</div>
                        </div>
                        <div class="card-body">

                            <!-- Date Filter -->
                            <form method="GET" action="{{ route('admin.delivered.report') }}" class="row g-3 mb-4">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('admin.delivered.report') }}" class="btn btn-secondary ms-2">Reset</a>
                                </div>
                            </form>
