...
@section('content')
    <div class="body-wrapper-inner">
        <div class="container-fluid">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4" style="margin-top:-70px;">Sub Menu Master</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('submenu_add') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="submenu_name" class="form-label">Sub Menu Name</label>
                                <input type="text" class="form-control" id="submenu_name" placeholder="Enter Sub Menu Name" name="submenu_name" required>
                            </div>

                            <div class="mb-3">
                                <label for="submenu_url" class="form-label">URL</label>
                                <input type="text" class="form-control" id="submenu_url" placeholder="Enter URL" name="submenu_url" required>
                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('submenu_update') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="edit_menu_id" class="form-label">Select Menu</label>
