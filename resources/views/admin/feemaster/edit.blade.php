...
@section('title', 'High Court of Jharkhand || Edit Fee Master')
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Fee Master Information</h3>
                        </div>
                        <form action="{{ route('fee_master.update', $feeMaster->fee_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="fee_type" 
                                                   name="fee_type" 
                                                   value="{{ old('fee_type', $feeMaster->fee_type) }}" 
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Fee Master
                                </button>
