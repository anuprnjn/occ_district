...
<body>
    <nav id="sidebar">
        <ul class="font-semibold">
            ...
            <li id="download_certified_copy">
                <a href="{{ route('downloadCC') }}">
