    ...
    <ul class="font-semibold">
        ...
        <li class="logout_btn">
            <form method="POST" action="{{ url('/logout-tracking') }}">
                @csrf
                <button type="submit" style="background-color: #dc2626; color: white; font-weight: 500; text-decoration: none; width: 100%; display: flex; align-items: center; gap: 8px; padding: 10px;border-radius: 8px;"
