...
class HcOrderNapixController extends Controller
{
    public function getHcOrderPdf(Request $request)
    {
        $cino = $request->input('cino');
        $order_date = $request->input('order_date');
        $order_no = $request->input('order_no');
        $subfolder = "high_court";

        $folder = "napix_pdf/{$subfolder}/{$cino}";
        ...
        $api_url = "https://delhigw.napix.gov.in/nic/ecourts/hc-order-api?dept_id={$dept_id}&request_str={$request_str}&request_token={$request_token}&version={$version}";
